...
import 'package:face_net_authentication/pages/db/databse_helper_employee_relief.dart';
...
class _RangkumanAbsensiHarianState extends State<RangkumanAbsensiHarian> {
  ...
  void initState() {
    ...
    _loadData();
    feelinAbsensiYgBelumAda();
  }

  feelinAbsensiYgBelumAda() async {
    DatabaseHelperEmployee helperEmployee = DatabaseHelperEmployee.instance;
    await _fillinYgBelumAbsensi_MALAM(
        await helperEmployee.queryAllEmployeeByShift("PDC_MALAM"));
    await _fillinYgBelumAbsensi_PAGI(
        await helperEmployee.queryAllEmployeeByShift("PDC_PAGI"));
    await _fillinYgBelumAbsensi_ONCALL(
        await helperEmployee.queryAllEmployeeByShift("PDC_ONCALL"));
    DatabaseHelperEmployeeRelief helperEmployeeRelief =
        DatabaseHelperEmployeeRelief.instance;
    await _fillinYgBelumAbsensi_MALAM(
        await helperEmployeeRelief.queryAllEmployeeByShift("PDC_MALAM"));
    await _fillinYgBelumAbsensi_PAGI(
        await helperEmployeeRelief.queryAllEmployeeByShift("PDC_PAGI"));
    await _fillinYgBelumAbsensi_ONCALL(
        await helperEmployeeRelief.queryAllEmployeeByShift("PDC_ONCALL"));
  }
  ...
  _fillinYgBelumAbsensi_MALAM(List<User> employees) async {
...
// Tambahkan elemen baru ke _attendanceList
  ...
  _fillinYgBelumAbsensi_PAGI(List<User> employees) async {
    // Buat set untuk menyimpan semua employee_id yang ada di _attendanceList
    Set<String?> existingEmployeeIds =
...
// Tambahkan elemen baru ke _attendanceList
  ...
  _fillinYgBelumAbsensi_ONCALL(List<User> employees) async {
    // Buat set untuk menyimpan semua employee_id yang ada di _attendanceList
    Set<String?> existingEmployeeIds =
