...
class MealFRScan extends StatefulWidget {
  const MealFRScan({Key? key, required this.MODE}) : super(key: key);

  final String MODE;
  @override
  MealFRScanState createState() => MealFRScanState();
}

class MealFRScanState extends State<MealFRScan> {
...
// RECONIZE_FACE();
  ...
  Widget build(BuildContext context) {
    Widget header = CameraHeader("ABSENSI " + widget.MODE.toUpperCase());
                ...
                children: [
                  DigitalClock(
                      ...
                      datetime: DateTime.now().add(Duration(
                          hours: CONSTANT_VAR.MEAL_SUBSTACT_FOR_DEBUG))),
