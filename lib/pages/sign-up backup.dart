...
//                         Image.asset("assets/images/absent_shift.png")
...
//       bool success_upload_fr = await repo.uploadFR(widget.user.employee_id!, encode_FR_ToBase64(predictedData), ImagePhoto);
