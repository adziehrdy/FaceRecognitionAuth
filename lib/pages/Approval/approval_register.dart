...
class _ApprovalRegisterState extends State<ApprovalRegister> {
  ...
  Widget build(BuildContext context) {
    ...
    user_list.isNotEmpty ? Container(
          ...
          return SizedBox(
              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    Text(textAlign: TextAlign.center,"Approval Karyawa Baru",style: TextStyle(fontSize: 20,color: Colors.blue,fontWeight: FontWeight.bold)),
                    Lottie.asset(
