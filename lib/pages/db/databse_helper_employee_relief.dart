...
$status_dk
  ...
  Future<int> deleteEmployeeRelief(String? employeeId) async {
    Database db = await instance.database;
    return await db
        .delete(table, where: '$employee_id = ?', whereArgs: [employeeId]);
  }
  ...
  Future<bool> isExistingInDB(String? employeeId) async {
