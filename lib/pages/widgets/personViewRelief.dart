...
class PersonViewRelief extends StatefulWidget {
  ...
  @override
  _PersonViewReliefState createState() => _PersonViewReliefState();
}

class _PersonViewReliefState extends State<PersonViewRelief> {
            ...
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return InkWell(
                      onTap: () async {
                        if (reliefChecker(
                            widget.personList[index].relief_start_date,
                            widget.personList[index].relief_end_date)) {
                          await showDialog(
                            context: context,
                          ...
                          showToast("Karyawan Relief Belum Aktif");
                        }
                      },
                      onLongPress: () {
                        if (reliefChecker(
