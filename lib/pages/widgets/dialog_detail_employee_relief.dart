...
class widget_detail_employee_relief extends StatefulWidget {
  final User user_detail;

  widget_detail_employee_relief({required this.user_detail});

  @override
  _widget_detail_employeeState createState() => _widget_detail_employeeState();
}

class _widget_detail_employeeState
    extends State<widget_detail_employee_relief> {
