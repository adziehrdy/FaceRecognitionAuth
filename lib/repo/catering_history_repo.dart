...
class CateringHistoryRepo {
  ...
  // Future updateRigStatusHistory(CateringHistoryModel data) async {
  //   try {
  //     Response res = await callApi(ApiMethods.POST, '/rig-catering/update',
  //         data: data.toMap());
  //     log(json.encode(res.data));
  //     return json.encode(res.data);
  //   } catch (e) {
  //     print("ERROR UPDATE CATERING HISTORY");
  //     return false;
  //   }
  // }
}
