...
DkListModel dkListModelFromJson(String str) => DkListModel.fromJson(json.decode(str));
...
class DkListModel {
    ...
    factory DkListModel.fromJson(Map<String, dynamic> json) => DkListModel(
        ...
        data: json["data"] == null ? [] : List<DK_data>.from(json["data"]!.map((x) => DK_data.fromJson(x))),
    );
